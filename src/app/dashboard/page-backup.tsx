...
import { TrendingUp, Calendar, Zap, Crown, ArrowRight, Sparkles, Lightbulb, Clipboard, Save, Settings } from 'lucide-react';
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          <Link href="/dashboard/board">
            <Card className="border-[#262626] bg-gradient-to-br from-[#1a1a1a] to-[#141414] hover:border-[#3a3a3a] transition-all cursor-pointer h-full">
              <CardContent className="p-4 sm:p-6 flex flex-col items-center text-center space-y-3">
                <Clipboard className="h-8 w-8 sm:h-10 sm:w-10 text-gray-400" />
          ...
          <Link href="/dashboard/saved">
            <Card className="border-[#262626] bg-gradient-to-br from-[#1a1a1a] to-[#141414] hover:border-[#3a3a3a] transition-all cursor-pointer h-full">
              <CardContent className="p-4 sm:p-6 flex flex-col items-center text-center space-y-3">
                <Save className="h-8 w-8 sm:h-10 sm:w-10 text-gray-400" />
